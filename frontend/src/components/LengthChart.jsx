...
function LengthChart({ results }) {
    ...
    datasets: [
      {
        ...
        data: results.map((r) => r.length || r.words || 0),
        backgroundColor: [
  ...
  return (
    <div className="chart-card glass-card">
      <h4 className="chart-title">Response Word Count</h4>
      <p className="chart-subtitle">Total words generated in the model's response</p>
