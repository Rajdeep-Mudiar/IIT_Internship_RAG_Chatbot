...
function LatencyChart({ results }) {
  ...
  return (
    <div className="chart-card glass-card">
      <h4 className="chart-title">Latency Comparison (Seconds)</h4>
      <p className="chart-subtitle">Lower values represent faster model response times</p>
